do  local ui =  game:GetService("CoreGui"):FindFirstChild("UI Color Hub")  if ui then ui:Destroy() end end
...
function Lib:Window(text,color)
    local uihide = false
    ...
    function Ui:Tab(text)
        ...
        UIGradientTabb.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, color), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(245, 245, 245))}
        ...
        function Tab:Page()
            ...
            function main:Button(text,callback)
                ...
                UIGradientBtn.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, color), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(245, 245, 245))}
            ...
            function main:Line()
				...
				LineUIGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(15, 15, 15)), ColorSequenceKeypoint.new(0.51, color), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(15, 15, 15))}
				LineUIGradient.Name = "LineUIGradient"
				LineUIGradient.Parent = Line
            end
            function main:Seperator(text)
                local SeperatorFrame = Instance.new("Frame")
                local SeperatorMain = Instance.new("Frame")
                local SeperatorUIGradient = Instance.new("UIGradient")
                local SeperatorText = Instance.new("TextLabel")
                local SeperatorUIGradient_SeperatorText = Instance.new("UIGradient")

				SeperatorFrame.Name = "SeperatorFrame"
				SeperatorFrame.Parent = ScrollingMainFramePage
				SeperatorFrame.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
				SeperatorFrame.BackgroundTransparency = 1.000
				SeperatorFrame.Position = UDim2.new(0, 0, 0.696864128, 0)
				SeperatorFrame.Size = UDim2.new(0, 328, 0, 40) -- 30

				SeperatorMain.Name = "SeperatorMain"
				SeperatorMain.Parent = SeperatorFrame
				SeperatorMain.AnchorPoint = Vector2.new(0.5, 0.5)
				SeperatorMain.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
				SeperatorMain.BorderSizePixel = 0
				SeperatorMain.Position = UDim2.new(0.5, 0, 0.428571433, 0)
				SeperatorMain.Size = UDim2.new(0, 296, 0, 2)

				SeperatorUIGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(14, 14, 14)), ColorSequenceKeypoint.new(0.51, color), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(14, 14, 14))}
				SeperatorUIGradient.Name = "SeperatorUIGradient"
				SeperatorUIGradient.Parent = SeperatorMain
				
				SeperatorText.Name = "SeperatorText"
				SeperatorText.Parent = SeperatorMain
				SeperatorText.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
				SeperatorText.BackgroundTransparency = 1.000
				SeperatorText.Position = UDim2.new(0.172297299, 0, -8.5, 0)
				SeperatorText.Size = UDim2.new(0, 192, 0, 12)
				SeperatorText.Font = Enum.Font.GothamBold
				SeperatorText.Text = text
				SeperatorText.TextColor3 = color -- Color3.fromRGB(255, 255, 255)
				SeperatorText.TextSize = 13.000
				
				SeperatorUIGradient_SeperatorText.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(255, 255, 255)), ColorSequenceKeypoint.new(1, Color3.fromRGB(255, 255, 255)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(255, 255, 255))}
				SeperatorUIGradient_SeperatorText.Name = "SeperatorUIGradientText"
				SeperatorUIGradient_SeperatorText.Parent = SeperatorText
            end
            ...
            function main:Toggle(text,default,callback)
                ...
                Tgle.Name = "Tgle"
                Tgle.Parent = Toggle
                Tgle.BackgroundColor3 = color
                Tgle.Position = UDim2.new(0, 6, 0, 3) -- 1,2
                Tgle.Size = UDim2.new(0, 18, 0, 18) -- 22

                UICornerTgle.CornerRadius = UDim.new(0, 25)
                ...
                local UICorner_lockerframe = Instance.new("UICorner")
                ...
                UICorner_lockerframe.CornerRadius = UDim.new(0, 6)
                UICorner_lockerframe.Parent = lockerframe
                ...
                LockerImageLabel.ImageColor3 = Color3.fromRGB(255,255,255)
            ...
            function main:Slider(text,min,max,set,callback)
                ...
                local UICornerBar_InBar = Instance.new("UICorner")
                --local Circlebar = Instance.new("TextButton")
				--local UICorner_Circlebar = Instance.new("UICorner")
                ...
                ClickHere.ClipsDescendants = false
                ...
                UICornerBarValue.CornerRadius = UDim.new(0, 25)
                UICornerBarValue.Name = "UICornerBarValue"
                UICornerBarValue.Parent = BarValue
                
                --Circlebar.Name = "Circlebar"
				--Circlebar.Parent = BarValue
				--Circlebar.BackgroundColor3 = Color3.fromRGB(235, 235, 235)
				--Circlebar.Position = UDim2.new(1, -2, 0, -3) -- 1, -2, 0, -3
				--Circlebar.TextTransparency = 1.000
				--Circlebar.AutoButtonColor = false
    			--Circlebar.Size = UDim2.new(0, 10, 0, 10)
				
				--UICorner_Circlebar.CornerRadius = UDim.new(0, 25)
				--UICorner_Circlebar.Parent = Circlebar
                ...
                --Circlebar.MouseButton1Down:Connect(function()
                    --if Tabtoggle == false then
                        ...
                        --TweenService:Create(
                            --Circlebar,
                            --TweenInfo.new(0.1,Enum.EasingStyle.Quad,Enum.EasingDirection.Out),
                            --{Position = UDim2.new(0, math.clamp(mouse.X - BarValue.AbsolutePosition.X - 2, 0, 261), 0, -3)}
                        --):Play()
 ...
 -- Original : 255, 0, 111 Green : 102, 204, 102 Blue : 32,143,252 Yellow : 255, 163, 26
local Data = os.date("%A, %B %d, %Y.")
local Folder = Lib:Window("Color Hub - "..tostring(Data),Color3.fromRGB(32,143,252))
local Tab1 = Folder:Tab("General")
local Page1 = Tab1:Page()
local Page2 = Tab1:Page()
Page1:Seperator('Main')
local Coin_Update = Page1:Label('Coin Earned : Loading')
-----------------------------------------
Page1:Toggle('Automatic Farm Coin',false,function(a)
    getgenv().Automatic_Farm_Callback = a
end)
Page1:Toggle('Instant Farm Coin [ Risk ]',false,function(a)
    getgenv().Automatic_Farm_Callback_Instant = a
end)
--Page1:Seperator('ESPs')
--Page1:Toggle('ESP Player',false,function(a)
--end)
--Page1:Toggle('ESP Coin',false,function(a)
--end)
Page1:Line()
-----------------------------------------
Page2:Seperator('Settings')
local Farm_Speed = Page2:Slider("Farm Speed",1,100,25,function(a)
    getgenv().Farm_Speed_Checked = a
end)
Page2:Button('Set To Original',function()
    Farm_Speed:Update(25)
end)
Page2:Line()
-----------------------------------------
-- [Functions Zone X Call Function]

getgenv().To_Postion = function(P)
    local Distance = (P.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude
    local TweenService = game:GetService("TweenService")
    local Tween_Info = TweenInfo.new(Distance/getgenv().Farm_Speed_Checked, Enum.EasingStyle.Linear)
    local Tween = TweenService:Create(game:GetService("Players")["LocalPlayer"].Character.HumanoidRootPart, Tween_Info, {CFrame = P})
    Tween:Play()
end

task.spawn(function()
    game:GetService("RunService").Heartbeat:Connect(function()
        if game:GetService("Players").LocalPlayer.Character:FindFirstChild("Humanoid") and getgenv().Automatic_Farm_Callback then
...
task.spawn(function()
    while task.wait(.5) do
        if getgenv().Automatic_Farm_Callback then
            local Coin_Checked = workspace:GetChildren()
            for i,v in pairs(Coin_Checked) do	    
                local Coin_Path = v:GetChildren()
                for i,v in pairs(Coin_Path) do
                    if v.Name == "CoinContainer" then
                        if v.Coin_Server:FindFirstChild("Coin") then
                            getgenv().To_Postion(v.Coin_Server.Coin.CFrame)
                        else
                            getgenv().Automatic_Farm_Callback = false
                            task.wait(1)
                            getgenv().Automatic_Farm_Callback = true
                        end
                    end
                end
            end
            game.Players.LocalPlayer.Character.Humanoid.Jump = true
            local Coin_Stack = game:GetService("Players").LocalPlayer.PlayerGui.MainGUI.Game.CashBag.CoinIcon.Coins.Text
            Coin_Update:Refresh("Coin Earned : "..Coin_Stack)
        else
            getgenv().To_Postion(game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame)
        end
    end
end)
